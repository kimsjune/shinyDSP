...
```{r trick, eval=FALSE, echo=FALSE, message=FALSE}
# I'm tricking R CMD build to silence a note about
# `svglite` not loading any functions.
# This is true. I just need svglite loaded to that
# ggsave() can use "svg"
library(svglite)
svglite::svglite()
```